...
function titleDivider(){
	setTimeout(function(){
		jQuery('.widget-title, #footer .footer-block-title, .block-layered-nav .filter-label, aside.sidebar .block-title, header.rating-title, .box-reviews .rating-subtitle, .block-related .block-title, #login-holder .page-title,.quick-view-title').each(function(){
  ...
  /* Coin Slider */
	...
	function replacingClass () {
	   ...
	   if (jQuery(document.body).width() > 479 && jQuery(document.body).width() < 768) { //iPhone
		...
		if (jQuery(document.body).width() > 767 && jQuery(document.body).width() < 991){ //Tablet
			mobile_menu('animate');
	    }
	...
	if (jQuery('#categories-accordion').length){
        //jQuery('#categories-accordion li.parent ul').before('<div class="btn-cat"><i class="fa fa-chevron-down"></i><i class="fa fa-minus-square-o"></i></div>');
