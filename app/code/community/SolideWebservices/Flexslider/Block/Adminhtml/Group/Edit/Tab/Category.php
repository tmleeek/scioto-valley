...
class SolideWebservices_Flexslider_Block_Adminhtml_Group_Edit_Tab_Category extends Mage_Adminhtml_Block_Catalog_Category_Tree {
	...
	public function __construct() {
		parent::__construct();
		$this->setTemplate('flexslider/edit/tab/category.phtml');
	}
	...
	public function isReadonly() {
		return $this->getCurrentGroup()->getCategoriesReadonly();
	}

	protected function getCategoryIds() {
		$_categoryList = $this->getCurrentGroup()->getCategoryId();
	...
	public function getCategoryChildrenJson($categoryId) {
		...
		return Mage::helper('flexslider')->jsonEncode($children);
	}
