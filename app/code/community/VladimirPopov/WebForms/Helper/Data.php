    ...
    extends Mage_Core_Helper_Abstract
{
    ...
    public function addAssets(Mage_Core_Model_Layout $layout)
    {
        ...
        if ($head && $content) {
            ...
            // tooltips
            $head->addJs('webforms/opentip/opentip-native-excanvas.min.js');
            $head->addItem('js_css','webforms/opentip/opentip.css');
            ...
            if (Mage::getStoreConfig('webforms/files/ajax')) {
                if (Mage::getStoreConfig('webforms/files/load_jquery')) {
                    $head->addJs('webforms/jQuery/jquery-1.11.1.min.js');
