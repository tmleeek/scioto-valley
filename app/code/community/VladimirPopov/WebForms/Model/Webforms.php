...
require_once(Mage::getBaseDir('lib') . '/Webforms/Smtpvalidate.php');
    ...
    extends VladimirPopov_WebForms_Model_Abstract
{
    ...
    public function getStatusEmailTemplateId($status){
        switch($status){
            case VladimirPopov_WebForms_Model_Results::STATUS_PENDING: return $this->getEmailTemplatePending();
