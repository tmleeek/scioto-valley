...
class VladimirPopov_WebForms_Block_Adminhtml_Webforms_Renderer_Action extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
	public function render(Varien_Object $row)
	{
		...
		$href = str_replace('webforms_admin','webforms',
				Mage::app()->getStore(Mage::getStoreConfig('webforms/general/preview_store'))->getUrl('webforms', array('_current'=>false,'id'=>$row->getId()))
		);
