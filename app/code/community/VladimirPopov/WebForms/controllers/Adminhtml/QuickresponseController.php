<?php
class VladimirPopov_WebForms_Adminhtml_QuickresponseController
	extends Mage_Adminhtml_Controller_Action
{
	...
	public function saveAction()
	{
		if( $this->getRequest()->getPost()){
			try{
				...
				if($saveandcontinue){
					$this->_redirect('*/adminhtml_quickresponse/edit',array('id' => $quickresponse->getId()));
				} else {
					$this->_redirect('*/adminhtml_quickresponse/index');
				}
				return;
			} catch (Exception $e){
	...
	public function massDeleteAction()
	{
		...
		$this->_redirect('webforms/adminhtml_quickresponse/index');
