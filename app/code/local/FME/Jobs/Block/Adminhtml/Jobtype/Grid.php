...
class FME_Jobs_Block_Adminhtml_Jobtype_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
      parent::__construct();
      $this->setId('jobtypeGrid');
      $this->setDefaultSort('jobtype_id');
  ...
  {
      $collection = Mage::getModel('jobs/jobtype')->getCollection();
  ...
  {
      $this->addColumn('jobtype_id', array(
    ...
    {
        $this->setMassactionIdField('jobtype_id');
