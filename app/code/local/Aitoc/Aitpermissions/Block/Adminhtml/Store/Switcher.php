...
class Aitoc_Aitpermissions_Block_Adminhtml_Store_Switcher extends Mage_Adminhtml_Block_Catalog_Category_Tree // Mage_Adminhtml_Block_Store_Switcher
{
    ...
    public function getRootNode($storeId = null)
    {
        ...
        $root = $this->getRoot(null, 5, $storeId);
    ...
    public function getRoot($parentNodeCategory=null, $recursionLevel=5, $storeId = null)
    {
    ...
    {
        $storeGroupId = $this->_getStoreGroupId($storeId);
        $rootArray    = $this->_getNodeJson($this->getRoot($parenNodeCategory, 5, $storeId), 1, $storeId);
    ...
    protected function _getSelectedNodes($storeId = null)
    {
        ...
        foreach ($this->getCategoryIds($storeGroupId) as $categoryId) 
        {
            ...
            {
                $this->_rootNodeTreesStorage[$storeGroupId] = $this->getRoot(null, 5, $storeId)->getTree(null, $storeId);
            }
    ...
    {
       	$rootArray = $this->_getNodeJson($this->getRoot($parenNodeCategory, 5, $storeId), 1, $storeId); //2
