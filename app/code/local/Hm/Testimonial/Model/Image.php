...
class Hm_Testimonial_Model_Image extends Mage_Core_Model_Abstract
{
    protected $_width;
    protected $_height;
    ...
    /**
     * @return Hm_Testimonial_Model_Image
     */
...
//        print '$this->_getNeedMemoryForBaseFile() = '.$this->_getNeedMemoryForBaseFile();
    ...
    {	
        ...
        if ((!$file) || (!file_exists($baseFile))) {
            throw new Exception(Mage::helper('testimonial')->__('Image file not found'));
        }
...
//            }
    ...
    {
        $directory = Mage::getBaseDir('media') . DS.'testimonial'.DS.'cache'.DS;
