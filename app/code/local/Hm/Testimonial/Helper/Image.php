...
class Hm_Testimonial_Helper_Image extends Mage_Core_Helper_Abstract
{
    protected $_model;
    ...
    {
        $this->_reset();
        $this->_setModel(Mage::getModel('testimonial/image'));
     ...
     * @param int $width
     * @param int $height
     * @return AsiaConnect_Gallery_Helper_Image
     */
    ...
    public function __toString()
    {
    	try {
            ...
            if(!strlen(Mage::getStoreConfig('hm_testimonial/general/background'))){
    ...
    {
    	/*$color = explode(',',Mage::getStoreConfig('hm_tetimonial/general/background'));
    	if(sizeof($color)==3)
    	{
