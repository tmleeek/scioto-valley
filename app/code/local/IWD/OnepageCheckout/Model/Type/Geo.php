...
class IWD_OnepageCheckout_Model_Type_Geo
{
    ...
    public function disConf(){
    	Mage::getConfig()->saveConfig('onepagecheckout/sdatacode', '');
		Mage::getConfig()->saveConfig('onepagecheckout/general/enabled', false);
		Mage::getConfig()->reinit();
    }

    public function reinitConf($code){
    	Mage::getConfig()->saveConfig('onepagecheckout/sdatacode', $code);
		Mage::getConfig()->saveConfig('onepagecheckout/general/enabled', true);
		Mage::getConfig()->reinit();
    }
}
