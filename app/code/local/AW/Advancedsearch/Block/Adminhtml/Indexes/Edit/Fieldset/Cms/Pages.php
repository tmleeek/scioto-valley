...
class AW_Advancedsearch_Block_Adminhtml_Indexes_Edit_Fieldset_Cms_Pages
    extends AW_Advancedsearch_Block_Adminhtml_Indexes_Edit_Fieldset_Abstract
{
    const TYPE = AW_Advancedsearch_Model_Source_Catalogindexes_Types::CMS_PAGES;

    protected function _getIndexAttributes()
    {
        return Mage::getModel('awadvancedsearch/source_catalogindexes_cms_page_attributes')->toShortOptionArray();
    }
