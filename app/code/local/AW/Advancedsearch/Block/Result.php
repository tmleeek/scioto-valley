...
class AW_Advancedsearch_Block_Result extends Mage_Core_Block_Template
{
    ...
    protected function _prepareLayout()
    {
        ...
        if ($breadcrumbs) {
            ...
            $breadcrumbs
                ...
                ->addCrumb('search', array('label' => $title, 'title' => $title));
        }
    ...
    public function getListBlock()
    {
        if ($this->_listBlock === null) {
            ...
            $this->_listBlock->addPriceBlockType(
                'bundle',
    ...
    public function getNoResultText()
    {
        if (Mage::helper('catalogsearch')->isMinQueryLength()) {
            return Mage::helper('catalogsearch')->__(
                ...
                Mage::helper('catalogsearch')->getMinQueryLength()
            );
        }
        return $this->__('There are no results that match your search');
    }
    ...
    {
        $currentType = $this->getRequest()->getParam('advsearchtype');
    ...
    public function getCMSPagesResultsHtml()
    {
        ...
        $cmsPagesBlock->setData(
            'index',
            $this->getResults(AW_Advancedsearch_Model_Source_Catalogindexes_Types::CMS_PAGES)
        );
