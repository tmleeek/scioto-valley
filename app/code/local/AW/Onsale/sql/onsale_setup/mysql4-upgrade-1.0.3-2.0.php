...
$setup->addAttribute(
    'catalog_product', 'aw_os_product_display', array(
...
$setup->addAttribute(
    'catalog_product', 'aw_os_product_position', array(
...
$setup->addAttribute(
    'catalog_product', 'aw_os_product_image', array(
...
$setup->addAttribute(
    'catalog_product', 'aw_os_product_text', array(
...
$setup->addAttribute(
    'catalog_product', 'aw_os_category_display', array(
        'backend'          => 'onsale/entity_attribute_backend_boolean_config',
        'source'           => 'onsale/entity_attribute_source_boolean_config',
        'label'            => 'Display',
...
$setup->addAttribute(
    'catalog_product', 'aw_os_category_position', array(
        'backend'          => 'onsale/entity_attribute_backend_position',
        'source'           => 'onsale/entity_attribute_source_position',
        'label'            => 'Position',
        'group'            => 'Category Label',
...
$setup->addAttribute(
    'catalog_product', 'aw_os_category_image', array(
        'backend'          => 'onsale/entity_attribute_backend_image',
        'label'            => 'Image',
        'group'            => 'Category Label',
        'input'            => 'image',
...
$setup->addAttribute(
    'catalog_product', 'aw_os_category_text', array(
        'source'           => 'onsale/entity_attribute_source_text',
        'group'            => 'Category Label',
        'label'            => 'Text',
        'note'             => 'You can use predefined values in this field. Please refer to extension manual.',
