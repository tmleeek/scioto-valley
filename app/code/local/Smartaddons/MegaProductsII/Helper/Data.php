<?php
/**PHP_COMMENT**/
class Smartaddons_MegaProductsII_Helper_Data extends Mage_Core_Helper_Abstract {
public function __construct(){
	...
	{
		$data = $this->defaults;
		$general 					= Mage::getStoreConfig("megaproductsii_cfg/general");
		$module_setting				= Mage::getStoreConfig("megaproductsii_cfg/module_setting");
		$product_selection 			= Mage::getStoreConfig("megaproductsii_cfg/product_selection");
		$category_setting 			= Mage::getStoreConfig("megaproductsii_cfg/category_setting");
		$product_display_setting 	= Mage::getStoreConfig("megaproductsii_cfg/product_display_setting");
		$advanced 					= Mage::getStoreConfig("megaproductsii_cfg/advanced");
