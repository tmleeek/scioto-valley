    ...
    extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        return $this->getUrl('*/adminhtml_webforms/logic', array('webform_id' => $this->getRequest()->getParam('id'), 'store' => $this->getRequest()->getParam('store')));
    }

    public function getRowUrl($row)
    {
        return $this->getUrl('*/adminhtml_logic/edit', array('id' => $row->getId(), 'webform_id' => $this->getRequest()->getParam('id'), 'store' => $this->getRequest()->getParam('store')));
    }
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem('delete', array(
            ...
            'url' => $this->getUrl('*/adminhtml_logic/massDelete', array(
        ...
        $this->getMassactionBlock()->addItem('status', array(
            ...
            'url' => $this->getUrl('*/adminhtml_logic/massStatus', array(
                'webform_id' => $this->getRequest()->getParam('id'),
                'store' => $this->getRequest()->getParam('store'))),
            'additional' => array(
                'visibility' => array(
