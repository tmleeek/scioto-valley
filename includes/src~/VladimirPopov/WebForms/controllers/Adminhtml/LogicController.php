<?php
class VladimirPopov_WebForms_Adminhtml_LogicController
    extends Mage_Adminhtml_Controller_Action
{
    ...
    public function massDeleteAction()
    {
        ...
        if ($this->getRequest()->getParam('webform_id')) {
            $this->_redirect('webforms/adminhtml_webforms/edit', array('id' => $this->getRequest()->getParam('webform_id'), 'tab' => 'logic', 'store' => $store));
            return;
        }
        $this->_redirect('webforms/adminhtml_fields/edit', array('id' => $this->getRequest()->getParam('field_id'), 'tab' => 'logic', 'store' => $store));
    }
