...
class Watsons_Exportorders_Model_Fs_Collection extends Varien_Data_Collection_Filesystem
{
    const EXTENSION = 'csv';
    ...
    protected function _generateRow($filename)
    {
        ...
        //Mage::log($row);
        foreach (Mage::getSingleton('exportorders/order')->load($row['basename'], $this->_baseDir)
