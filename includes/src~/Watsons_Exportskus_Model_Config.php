 ...
 * Config.php
 */
class Watsons_Exportskus_Model_Config 
{	
    const XML_ENABLED       = 'exportskus_section/settings/enabled';
    const XML_LOG_ENABLED   = 'exportskus_section/settings/log_enabled';
    ...
    public function log($message, $storeId = NULL)
    {
        ...
        Mage::log($message, null, 'exportskus.log');
    }
}